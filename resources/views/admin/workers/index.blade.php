        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-[#FFFFFF] bg-opacity-50 shadow-xl rounded-lg p-8">
                ...
                <div class="flex flex-col items-center text-center mb-6">
                    <h3 class="text-3xl font-bold text-[#FFFFFF]">Gestión de Trabajadores</h3>
                    <a href="{{ route('admin.workers.create') }}" 
                       class="mt-4 px-5 py-2 bg-[#801336] text-white rounded-md font-semibold font-semibold rounded-md hover:bg-[#9b1a3e] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#801336]">
                        Agregar Trabajador
                    </a>
                </div>

                <!-- Encabezado de la sección de la tabla -->
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-2xl font-semibold text-[#FFFFFF]">Listado de Trabajadores</h2>
                </div>
                    ...
                    <table class="w-full bg-white bg-opacity-95 rounded-lg shadow-lg mt-4">
                        <thead>
                            <tr class="bg-[#801336] text-white">
                                <th class="px-6 py-3 border-b-2 border-[#801336] text-left text-sm">Nombre</th>
                                <th class="px-6 py-3 border-b-2 border-[#801336] text-left text-sm">Correo</th>
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-[#E7E3C4] transition duration-150">
                                <td class="px-6 py-3 border-b border-[#801336] text-[#801336] text-sm">{{ $worker->name }}</td>
                                <td class="px-6 py-3 border-b border-[#801336] text-[#801336] text-sm">{{ $worker->email }}</td>
                                <td class="px-6 py-3 border-b border-[#801336]">
                                    <div class="flex items-center gap-4">
                                        <!-- Botón de editar con ícono -->
                                        <a href="{{ route('admin.workers.edit', $worker->id) }}" class="flex items-center text-[#6A92C7] hover:text-[#6A92C7] font-semibold space-x-1">
