        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-[#FFFFFF] bg-opacity-50 shadow-xl rounded-lg p-8">
                ...
                <div class="flex flex-col items-center text-center mb-6">
                    <h3 class="text-display-sm text-primary font-bold">Gestión de Trabajadores</h3>
                    <a href="{{ route('admin.workers.create') }}"
                       class="mt-4 px-5 py-2 bg-primary text-white text-body-md font-semibold rounded-md hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary btn-accessible">
                        Agregar Trabajador
                    </a>
                </div>
                ...
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-heading-lg text-primary font-semibold">Listado de Trabajadores</h2>
                </div>
                                ...
                                <td class="px-6 py-3 border-b border-[#801336]">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <form action="{{ route('admin.workers.destroy', $worker->id) }}" method="POST" class="flex items-center">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="flex items-center text-error hover:text-error-dark text-body-md font-medium space-x-1 transition duration-150">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
