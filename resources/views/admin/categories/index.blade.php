        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-[#FFFFFF] bg-opacity-50 shadow-xl rounded-lg p-8">
                ...
                <div class="flex flex-col items-center text-center mb-6">
                    <img src="../img/logo.jpeg" alt="Logo" class="w-24 h-24 mb-4 rounded-full border-4 border-[#801336]" />
                    <h3 class="text-3xl font-bold text-[#FFFFFF]">Gestión de Categorías</h3>
                </div>
                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr class="hover:bg-[#E7E3C4] transition duration-150">
                                    <td class="px-6 py-3 border-b border-[#801336] text-[#801336]">{{ $category->name }}</td>
                                    <td class="px-6 py-3 border-b border-[#801336]">
                                        <div class="flex items-center gap-4">
                                            <!-- Botón de Editar con ícono -->
                                            <a href="{{ route('admin.categories.edit', $category->id) }}" 
                                               class="flex items-center text-[#6A92C7] hover:text-[#6A92C7] font-semibold space-x-1">
