<x-app-layout>
    <div class="py-6">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-[#FFFFFF] bg-opacity-50 shadow-xl rounded-lg p-4 sm:p-8">
                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr class="hover:bg-[#E7E3C4] transition duration-150">
                                    <td class="px-4 sm:px-6 py-3 border-b border-[#801336] text-[#801336]">{{ $category->name }}</td>
                                    <td class="px-4 sm:px-6 py-3 border-b border-[#801336]">
