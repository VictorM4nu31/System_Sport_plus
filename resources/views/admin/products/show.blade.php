                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <a href="{{ route('admin.products.index') }}"
                           class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 font-semibold">
                            Volver al Listado
                        </a>
                    </div>
                </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-[#801336]">${{ number_format($product->price, 2) }}</p>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-600">Stock</label>
                                    <p class="text-lg font-semibold {{ $product->stock <= 0 ? 'text-red-600' : ($product->stock <= 10 ? 'text-yellow-600' : 'text-green-600') }}">
                                ...
                                <div>
                                    ...
                                    <p class="text-lg">{{ $product->category->name ?? 'Sin categoría' }}</p>
                                </div>
                                @if($product->sport_type)
                                <div>
                                    <label class="block text-sm font-medium text-gray-600">Tipo de Deporte</label>
                        ...
                        <!-- Características -->
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h2 class="text-xl font-semibold text-[#801336] mb-4">Características</h2>
                            <div class="grid grid-cols-2 gap-4">
                                @if($product->gender)
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="text-lg">{{ $product->material }}</p>
                                </div>
                                @endif
                                @if($product->weight)
                                <div>
                                    <label class="block text-sm font-medium text-gray-600">Peso</label>
                                    <p class="text-lg">{{ $product->weight }} kg</p>
                                </div>
                                @endif
                                <div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h2 class="text-xl font-semibold text-[#801336] mb-4">Variantes Disponibles</h2>

                            @if($product->sizes && count($product->sizes) > 0)
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-600 mb-2">Tallas</label>
                                <div class="flex flex-wrap gap-2">
                                    @foreach($product->sizes as $size)
                                        <span class="inline-block bg-[#801336] text-white px-3 py-1 rounded-md text-sm font-medium">
                                            {{ $size }}
                                        </span>
                                    @endforeach
                                </div>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-600 mb-2">Colores</label>
                                <div class="flex flex-wrap gap-2">
                                    @foreach($product->colors as $color)
                                        <span class="inline-block bg-gray-200 text-gray-800 px-3 py-1 rounded-md text-sm font-medium">
                                            {{ $color }}
                                        </span>
                                    @endforeach
                                </div>
                ...
                <div class="mt-8 bg-gray-50 p-6 rounded-lg">
                    <h2 class="text-xl font-semibold text-[#801336] mb-4">Descripción del Producto</h2>
                ...
                <div class="mt-8 bg-gray-50 p-6 rounded-lg">
                    <h2 class="text-xl font-semibold text-[#801336] mb-4">
                ...
                <div class="mt-8 bg-blue-50 p-6 rounded-lg border border-blue-200">
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl font-semibold text-[#801336]">Integración con Stripe</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 font-mono text-sm">{{ $product->stripe_product_id }}</p>
                        </div>
                        @endif
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 font-mono text-sm">{{ $product->stripe_price_id }}</p>
                        </div>
                        @endif
                ...
                <div class="mt-8 bg-gray-50 p-6 rounded-lg">
                    <h2 class="text-xl font-semibold text-[#801336] mb-4">Información del Sistema</h2>
                        ...
                        if (data.success) {
                            ...
                            if (data.stripe_product) {
                                ...
                                if (data.stripe_product.metadata) {
                                    ...
                                    html += '<div class="bg-gray-50 p-2 rounded mt-2 text-xs">';
                            ...
                            container.innerHTML = `<div class="bg-red-50 border border-red-200 p-4 rounded-lg"><p class="text-red-600">Error: ${data.error}</p></div>`;
                        }
                    })
                    .catch(error => {
                        container.innerHTML = `<div class="bg-red-50 border border-red-200 p-4 rounded-lg"><p class="text-red-600">Error al cargar información: ${error.message}</p></div>`;
                    });
            } else {
