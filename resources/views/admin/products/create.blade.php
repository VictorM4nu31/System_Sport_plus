<x-app-layout>
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 py-6">
        ...
        <div class="bg-white bg-opacity-95 shadow-lg rounded-lg p-8">
            <h1 class="text-3xl text-center font-bold text-[#801336] mb-8">Agregar Producto Deportivo</h1>
            ...
            <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" id="productForm">
                ...
                <div class="bg-gray-50 p-6 rounded-lg mb-6">
                    <h2 class="text-xl font-semibold text-[#801336] mb-4">Especificaciones Técnicas (Opcional)</h2>
