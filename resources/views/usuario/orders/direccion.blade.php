    ...
    <div class="max-w-lg mx-auto py-8 px-6 bg-gray-50 shadow-md">
        ...
        <form method="POST" action="{{ route('usuario.orders.direccion') }}">
            ...
            <div class="mb-4">
                ...
                <a href="https://micodigopostal.org/" class="text-blue-500 text-xs hover:underline mt-1 inline-block">No sé mi código</a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input id="municipality" name="municipality" type="text" readonly 
                           class="mt-1 block w-full border border-gray-300 p-2 rounded-md bg-gray-100 shadow-sm">
                </div>
            </div>
            ...
            <div class="mb-4">
                <label for="interior_number" class="block text-gray-700 font-medium text-sm">Nº interior/Depto (opcional)</label>
            ...
            <div class="mb-4">
                <label for="additional_instructions" class="block text-gray-700 font-medium text-sm">Indicaciones adicionales</label>
            ...
            <!-- Botón de Guardar -->
            <button type="submit" class="bg-[#801336] text-white font-semibold p-2 rounded-md w-full hover:bg-blue-600 transition duration-300">Guardar</button>
        </form>
    </div>
</x-app-layout>
